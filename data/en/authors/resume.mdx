...
- **Responsibilities**:
  ...
  - Document APIs in detail at [https://yukicoding.github.io/get-a-room-api-docs/](https://yukicoding.github.io/get-a-room-api-docs/)
...
- [Shopify Theme Starter](https://github.com/yukicoding/shopify-theme-starter): Starter kit to build a Shopify Theme from scratch includes Webpack 5 and Tailwind CSS
- [Tiny retry](https://github.com/yukicoding/tiny-retry): A lightweight module (~0.5kb) to retry an async job until the job success or stop after a maximum number of tries
- [Slider-x](https://www.npmjs.com/package/slider-x): Vanilla JS library for PageFly premium element - SlideShow
- [Nodejs Google APIs Starter](https://github.com/yukicoding/nodejs-google-api-starter): NodeJS starter code for PageFly Analytics feature
- [Travel Egypt](https://github.com/yukicoding/Travel_Egypt): Picture puzzle game built with pygame (Python)
- [Infinite Gallery](https://github.com/yukicoding/infinite-gallery): Infinite loading modal gallery
- [Store Manager](https://github.com/yukicoding/StoreManager) Desktop store management app using Java Swing, JDBC, SQL Server
